...
HRESULT InitDevice()
{
	...
	vertices[0].Pos = XMFLOAT3(-0.5f, 0.5f, 0.5f);
	vertices[1].Pos = XMFLOAT3(0.0f, 0.0f, 0.5f);
	vertices[2].Pos = XMFLOAT3(-0.5f,-0.5f, 0.5f);

	vertices[3].Pos = XMFLOAT3(0.0f, 0.0f, 0.5f);
	vertices[4].Pos = XMFLOAT3(0.5f, 0.5f, 0.5f);
	vertices[5].Pos = XMFLOAT3(0.5f, -0.5f, 0.5f);
