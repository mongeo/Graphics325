	...
	int       nCmdShow)
{
	...
	hMain = CreateWindow(MainWin, "Pong - Lab 2", WS_OVERLAPPEDWINDOW | WS_VISIBLE, 100, 50, 500, 300, NULL, NULL, hInst, NULL);
	if (!hMain)return 0;
...
void OnPaint(HWND hwnd)
	...
	*/
	...
	//ball
	draw_line(DC, bx, by, bx+1, by+1, 0, 0, 255, ballSize);
	//right paddle
	draw_rectangle(DC, 450, dy - 10, 450, dy + 10, 255, 0, 0, 5);
